...
#define CONFIG_HOSTNAME           "esp32-dobre"
#define TO_FIND_HOSTNAME       "esp32-stefanache"
...
void app_main(void)
{
    ...
    if (connected) {
        ...
        // discover and list the IP addresses of other available platforms
        esp_err_t err = mdns_query_a(TO_FIND_HOSTNAME, 2000, &addr);
        if(err){
